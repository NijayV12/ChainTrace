...
export interface SummarizeAccountInvestigationResponse extends AccountInvestigationSummary {
}
...
export type AIEngineRuntimeRequest = {
    kind: "evaluate";
    payload: EvaluateAccountRiskRequest;
} | {
    kind: "summarize";
    payload: SummarizeAccountInvestigationRequest;
};
export type AIEngineRuntimeResponse = EvaluateAccountRiskResponse | SummarizeAccountInvestigationResponse | HealthResponse;
