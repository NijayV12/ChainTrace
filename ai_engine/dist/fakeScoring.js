...
function profileComponentScore(f) {
...
function networkComponentScore(f) {
...
function activityComponentScore(f) {
    let freqScore;
    if (f.postingFrequency === 0)
        freqScore = 40;
    else if (f.postingFrequency < 0.1)
        freqScore = 50;
    else if (f.postingFrequency <= 10)
        freqScore = 100;
    else if (f.postingFrequency <= 30)
        freqScore = 70;
    else
        freqScore = 40;
...
function contentComponentScore(f) {
...
function identitySecurityComponentScore(f) {
...
export function computeFakeTrustScore(features) {
